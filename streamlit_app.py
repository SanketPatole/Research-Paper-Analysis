...
class GenAI_Wrpapper:
	...
	def get_summary(self, research_paper_content):
		...
		response = self.run_component_qa_chain(component, chatgpt3_5_turbo, vectordb)
		summary += "\n\n\n\n<" + component + ">\n\n"
		summary += "###" + response[component] + "###"
		response = self.run_summary_llm_chain(chat_client=chatgpt3_5_turbo, component_summary=summary, components_list=components)
